<template>
  <div
    class="flex flex-col py-4 px-6 shadow-md bg-white hover:bg-gray-50 h-[360px] rounded-lg"
  >
    <img
      :src="
        survey.image_url ||
    ...
    />
    <h4 class="mt-4 text-lg font-bold flex-1">{{ survey.title }}</h4>
...
import { PencilIcon, ArrowTopRightOnSquareIcon, TrashIcon  } from '@heroicons/vue/24/solid'
